  ...
  return (
    <div className="top-margin">
      <Paper className="paper-margin" elevation={10}>
        ...
        <h4>Etapas de Desarrollo de Negocio</h4>
        ...
        <h4>Sub-etapas de Idea / Concepto</h4>
        ...
        <Accordion expanded={expanded === 'panel17'} onChange={handleChange('panel17')}>
         ...
         <h4>Sub-etapas de Prueba de Concepto/Prototipo/Entrada al Mercado</h4>
        ...
        <h4>Sub-etapas de Lanzamiento</h4>      
        ...
        <h4>Sub-etapas de Crecimiento/Expansión</h4>      
