...
async function getOrganizations(){
    try {
        const res = await pool.query(
          `SELECT o.org_id, o.name, o.description, o.email, o.phone_number, t.bt_id, b.bstage_id, o.bs_id, o.is_active, o.org_link
          FROM public.organization as o inner join organization_business_type as t on o.org_id = t.org_id
          inner join business_step as B on O.bs_id = b.bs_id
